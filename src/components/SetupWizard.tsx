    ...
    <section className="bg-dark-bg text-white py-16 border-b border-white/5" id="setup-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="text-sm text-gradient-blue tracking-widest bg-white/5 border border-blue-400/20 px-3 py-1 rounded-full mb-3 inline-block uppercase" style={{ fontFamily: "'Modak', cursive" }}>STAP-VOOR-STAP INSTALLATIE</span>
